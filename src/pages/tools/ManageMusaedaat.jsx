...
export default function ManageMusaedaat() {
  const { masoolData } = useData()
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-slate-800">Manage Musaedaat Women Committee</h1>
        <p className="text-sm text-slate-500">Configure Musaedaat assignments</p>
      </div>
